// Showed CREATIVITY by adding a log that counts and displays 
// how many activities have been done at the end of the program. 
// Created another "counter" that shows emoji faces going from sad to happy. 
// This counter is used in the DisplayEndingMessage() function.
...
class Program
{
    ...
    {
        // lists that will be used by Listing activity and Reflecting Activity
        ...
        //breathing activity object that will be used in the program.
        ...
        while (userInp != "4") 
        {
            ...
            {
                Console.Write($"Thank you for using the wellness program. ");
            }
            else {
